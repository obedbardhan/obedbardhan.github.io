...
(function () {
    ...
    const STATIC_STOP_WORDS = {
        ...
        german: ['und', 'aber', 'für', 'in', 'mit', 'ohne', 'bei', 'von', 'zu', 'der', 'die', 'das', 'ein', 'eine', 'mein', 'dein', 'sein', 'unser', 'euer', 'ihr', 'an', 'auf', 'um'],
        spanish: ['y', 'pero', 'para', 'en', 'con', 'sin', 'bajo', 'sobre', 'entre', 'por', 'el', 'la', 'los', 'las', 'un', 'una', 'unos', 'unas', 'este', 'esta', 'ese', 'esa', 'mi', 'tu', 'su'],
        chinese: ['的', '了', '在', '和', '是', '我', '你', '他', '她', '它', '我们', '你们', '他们', '它们', '这', '那', '哪', '都', '就', '也', '还', '已经'],
        hebrew: ['את', 'של', 'על', 'עם', 'אל', 'מן', 'היה', 'היו', 'הוא', 'היא', 'הם', 'הן', 'זה', 'זאת', 'אלה', 'אשר', 'כי', 'גם']
    };
